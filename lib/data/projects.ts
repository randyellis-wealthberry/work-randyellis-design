...
//
// Array order IS the /projects reading order — that route renders this list
// straight through, unsorted. The sequence deliberately alternates category so
// no two mobile app case studies sit adjacent: four mobile projects against
// five non-mobile ones interleave exactly, and a run of them reads as one
// repeated engagement rather than a range of work. Waffle leads because it is
// the only live product a reader can open today. When adding a project, place
// it against that alternation rather than appending.
