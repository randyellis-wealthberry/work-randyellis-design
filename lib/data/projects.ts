...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    processStory: {
      ...
      approach:
        "Our approach centered on comprehensive user research and practical logistics industry expertise. We conducted extensive stakeholder interviews and on-site field research, embedding ourselves in the daily operations of drivers and dispatch teams to understand real-world challenges and workflows. The development strategy focused on creating a dual-platform solution: native mobile applications optimized for drivers' working conditions and a robust web application for dispatch teams and customer service representatives. The design process emphasized driver experience, recognizing that adoption in a traditionally low-tech industry required exceptional usability and clear value proposition.",
      methodology:
