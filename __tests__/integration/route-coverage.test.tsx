...
const EXPECTED_ROUTES = [
  ...
  // Blog routes (MDX)
  { path: "/blog/create-professional-videos-claude-code-guide", name: "Professional Videos Guide" },
  { path: "/blog/exploring-the-intersection-of-design-ai-and-design-engineering", name: "Design AI Intersection" },
  { path: "/blog/product-manager-guide-ai-evaluations", name: "PM Guide AI Evaluations" },
...
describe("TDD PHASE 1: Route Coverage Analysis", () => {
  describe("Static Route Verification", () => {
    test("should have all expected static routes defined", () => {
      const staticRoutes = EXPECTED_ROUTES.filter(route => 
