...
const mockTrackNewsletterAttempt =
  trackNewsletterAttempt as jest.MockedFunction<typeof trackNewsletterAttempt>;
...
describe("Newsletter Component Integration Tests", () => {
  ...
  describe("API Integration", () => {
    test("should handle successful submission", async () => {
      ...
      expect(mockTrackNewsletterAttempt).toHaveBeenCalledWith(
        "submit_start",
        false,
      );
      expect(mockTrackNewsletterAttempt).toHaveBeenCalledWith(
  ...
  describe("FloatingInput Component", () => {
    ...
    test("should show error message when provided", () => {
      render(
        <FloatingInput label="Email" type="email" error="Invalid email" />,
      );
