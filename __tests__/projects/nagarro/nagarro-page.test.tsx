...
const expectedMetadata: Metadata = {
  title:
    "Nagarro Design Leadership Case Study | Strategic Design Transformation",
  description:
    "How strategic design leadership at Nagarro boosted brand recognition by 50%, generated 100+ leads, and improved team retention by 40% through design thinking and strategic initiatives.",
  openGraph: {
    title: "Nagarro Design Leadership | IT Consulting Design Transformation",
    description:
      "Strategic design leadership case study: 50% brand recognition increase, 100+ leads generated, 40% team retention improvement at global IT consulting firm.",
    type: "article",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "How design leadership achieved 50% brand recognition boost and 100+ qualified leads at global IT consulting firm.",
...
describe("Nagarro Case Study Page - TDD Implementation", () => {
  describe("Page Structure and Content", () => {
    ...
    it("displays correct case study title and subtitle", () => {
      ...
      expect(
        screen.getByText(mockNagarroData.hero.subtitle),
      ).toBeInTheDocument();
    });
  ...
  describe("Metrics Section", () => {
    ...
    it("ensures all metrics have semantic heading structure", () => {
      ...
      mockNagarroData.metrics.forEach((metric) => {
        expect(
          screen.getByRole("heading", { level: 3, name: metric.label }),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("External Links Integration", () => {
    it("renders external documentation links with proper attributes", () => {
      ...
      expect(externalSection).toHaveAttribute(
        "aria-label",
  ...
  describe("SEO and Metadata Validation", () => {
    it("validates expected metadata structure", () => {
      ...
      expect(expectedMetadata.openGraph?.title).toContain(
        "Nagarro Design Leadership",
      );
      ...
      expect(expectedMetadata.twitter?.title).toContain(
        "Strategic Design Transformation",
      );
      expect(expectedMetadata.twitter?.description).toContain(
        "100+ qualified leads",
      );
    });
