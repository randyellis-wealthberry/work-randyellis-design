...
const MockResponsiveNagarroLayout = () => {
  return (
    <div className="responsive-case-study" data-testid="responsive-container">
      ...
      <header className="w-full px-4 md:px-6 lg:px-8" data-testid="responsive-header">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-2 lg:order-1" data-testid="hero-content">
                ...
                <div className="space-y-2 md:space-y-3 mb-6" data-testid="client-info-responsive">
                  <div className="flex flex-col sm:flex-row sm:items-center">
                    <span className="font-semibold text-sm md:text-base mr-2">Client:</span>
                    <span className="text-sm md:text-base">{mockNagarroResponsiveData.client}</span>
                  </div>
                </div>

                {/* Platform Badges - Responsive Grid */}
                <div className="mb-6" data-testid="platforms-responsive">
                  <h3 className="font-semibold text-sm md:text-base mb-2">Platforms:</h3>
                  <div className="flex flex-wrap gap-2 md:gap-3">
                    {mockNagarroResponsiveData.hero.platforms.map((platform, index) => (
                      <span 
                        key={index} 
              ...
              <div className="order-1 lg:order-2" data-testid="hero-media-responsive">
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              >
                <div className="flex-shrink-0 text-2xl mb-2 sm:mb-0 sm:mr-4">📄</div>
                <div>
                  <h3 className="font-semibold text-sm md:text-base mb-1">Complete Case Study</h3>
                  <p className="text-xs md:text-sm text-gray-600">View on Scribd</p>
                </div>
              </a>
              ...
              >
                <div className="flex-shrink-0 text-2xl mb-2 sm:mb-0 sm:mr-4">✍️</div>
                <div>
                  <h3 className="font-semibold text-sm md:text-base mb-1">Design Leadership Article</h3>
                  <p className="text-xs md:text-sm text-gray-600">Read on Medium</p>
                </div>
              </a>
            </div>
          </div>
      ...
      <footer className="px-4 md:px-6 lg:px-8 py-6 md:py-8" data-testid="responsive-footer">
...
describe('Nagarro Case Study - Responsive Design Tests', () => {
  ...
  describe('Mobile Viewport (320px - 767px)', () => {
    ...
    it('uses single column grid for metrics on mobile', () => {
      ...
      expect(metricsGrid).toHaveClass('grid-cols-1', 'sm:grid-cols-2', 'lg:grid-cols-3')
    })

    it('adjusts typography for mobile readability', () => {
      render(<MockResponsiveNagarroLayout />)
      
      const header = screen.getByTestId('responsive-header').querySelector('h1')
    ...
    it('handles mobile menu interaction', async () => {
      ...
      const mobileToggle = screen.getByTestId('mobile-menu-toggle')
      expect(mobileToggle).toHaveAttribute('aria-label', 'Toggle mobile navigation menu')
  ...
  describe('Responsive Video and Media', () => {
    it('maintains aspect ratio across viewports', () => {
      ...
      const videoContainer = screen.getByTestId('hero-media-responsive').querySelector('.relative')
    ...
    it('provides accessible video controls across devices', () => {
      ...
      expect(video).toHaveAttribute('poster', mockNagarroResponsiveData.hero.heroImage)
    })
  })
  ...
  describe('Grid and Layout Consistency', () => {
    it('maintains consistent grid behavior across breakpoints', () => {
      ...
      mockNagarroResponsiveData.metrics.forEach((_, index) => {
        expect(screen.getByTestId(`responsive-metric-${index}`)).toBeInTheDocument()
      })
    })
