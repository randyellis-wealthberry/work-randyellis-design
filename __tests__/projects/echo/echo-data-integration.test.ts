...
describe('Echo Project Data Integration', () => {
  ...
  describe('Project Existence and Basic Properties', () => {
    ...
    it('should have correct basic metadata', () => {
      ...
      expect(echoProject?.subtitle).toBe('AI-Powered Cloud Intelligence Platform');
  ...
  describe('Content and Descriptions', () => {
    ...
    it('should have detailed long description', () => {
      ...
      expect(echoProject?.longDescription).toContain('intelligent file ecosystem');
      expect(echoProject?.longDescription).toContain('computer vision');
      expect(echoProject?.longDescription).toContain('natural language processing');
    });
    ...
    it('should contain key AI/ML terminology', () => {
      ...
      expect(combinedText.toLowerCase()).toMatch(/(machine learning|ml|artificial intelligence|predictive|computer vision)/);
    });
  });

  describe('Categories and Tags', () => {
    it('should have correct categories', () => {
      expect(echoProject?.categories).toEqual(['Enterprise (SaaS)', 'AI/ML', 'Web Development']);
    });
  ...
  describe('Metrics and Performance Data', () => {
    ...
    it('should have impressive metric values', () => {
      ...
      const productivityMetric = metrics.find(m => m.label === 'Team Productivity Boost');
      ...
      const filesOrganized = metrics.find(m => m.label === 'Files Automatically Organized');
  ...
  describe('Challenges and Solutions', () => {
    ...
    it('should address enterprise-scale file management challenges', () => {
      ...
      expect(challenges.toLowerCase()).toMatch(/(collaboration.*inefficienc|inefficient.*collaboration)/);
    ...
    it('should provide AI-focused solutions', () => {
      ...
      expect(solutions.toLowerCase()).toMatch(/(machine learning|predictive|intelligent)/);
      expect(solutions).toContain('intelligent search');
    });

    it('should have equal number of solutions to challenges', () => {
      expect(echoProject?.solutions?.length).toEqual(echoProject?.challenges?.length);
    });
  });
  ...
  describe('Process Story and Learning Outcomes', () => {
    ...
    it('should emphasize AI-first approach in process story', () => {
      ...
      expect(approach.toLowerCase()).toMatch(/(ai-powered|ai-first|artificial intelligence)/);
    ...
    it('should include measurable outcomes', () => {
      ...
      expect(outcome.toLowerCase()).toMatch(/storage.*cost.*45%|45%.*storage.*cost/i);
    });

    it('should have stakeholder quotes', () => {
      expect(echoProject?.processStory?.stakeholderQuotes).toBeDefined();
      expect(echoProject?.processStory?.stakeholderQuotes!.length).toBeGreaterThanOrEqual(3);
    ...
    it('should have meaningful learnings', () => {
      ...
      expect(learnings.toLowerCase()).toMatch(/(enterprise|organization|workflow)/);
  ...
  describe('Media and Visual Assets', () => {
    it('should have proper media paths', () => {
      expect(echoProject?.video).toBe('/projects/echo/echodrive-mockup-video.mp4');
  ...
  describe('Enhanced Metrics for Echo Client Component', () => {
    it('should provide data that supports the enhanced metrics used in the component', () => {
      ...
      const metricsText = echoProject?.metrics?.map(m => `${m.label}: ${m.value}`).join(' ') || '';
