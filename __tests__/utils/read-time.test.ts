import {
  calculateReadTime,
  calculateAdvancedReadTime,
  type ArticleMetadata,
} from "@/lib/utils/read-time";

describe("calculateReadTime", () => {
  it("should calculate basic read time correctly", () => {
    const content =
      "This is a test content with exactly twenty words to test the basic reading time calculation function properly here.";
