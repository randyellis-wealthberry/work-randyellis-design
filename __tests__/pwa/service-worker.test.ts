...
const mockCache = {
  ...
  match: jest.fn() as jest.MockedFunction<
    (request: RequestInfo) => Promise<Response | undefined>
  >,
  matchAll: jest.fn() as jest.MockedFunction<
    (request?: RequestInfo) => Promise<readonly Response[]>
  >,
...
describe("Service Worker Tests", () => {
  ...
  describe("Service Worker Registration", () => {
    ...
    it("should handle service worker registration failure gracefully", async () => {
      ...
      mockServiceWorker.register.mockRejectedValue(
        new Error("Registration failed") as any,
      );
  ...
  describe("Offline Functionality", () => {
    ...
    it("should handle offline state changes", () => {
      ...
      global.addEventListener = jest.fn() as jest.MockedFunction<
        typeof addEventListener
      >;
      global.dispatchEvent = jest.fn() as jest.MockedFunction<
        (event: Event) => boolean
      >;
