  ...
  describe("🔴 RED PHASE: Expected Behavior (Should Fail Initially)", () => {
    it("should render /projects/addvanced route successfully", async () => {
      ...
      try {
        ...
        expect(
          screen.getByText("Addvanced Career Tracker Case Study"),
        ).toBeInTheDocument();
      } catch (error) {
        // Expected to fail initially - route doesn't exist yet
        expect(error).toBeDefined();
        console.log(
          "✅ Expected failure: /projects/addvanced route doesn't exist yet",
        );
      }
    });
    ...
    it("should have correct breadcrumb structure for projects", () => {
      ...
      try {
        ...
        expect(
          screen.getByText("Addvanced Career Tracker"),
        ).toBeInTheDocument();
    ...
    it("should have metadata URLs pointing to /projects/addvanced", () => {
      ...
      const expectedMetadata = {
        ...
        twitter: {
          images: [
            "https://work.randyellis.design/projects/addvanced/A1-Home.png",
          ],
        },
      };
      ...
      console.log(
        "✅ Metadata URL test ready - expects /projects/addvanced structure",
      );
    });
    ...
    it("should redirect /addvanced to /projects/addvanced with 301 status", () => {
      ...
      console.log(
        "✅ Redirect test ready - middleware should redirect",
        oldPath,
        "to",
        newPath,
      );
