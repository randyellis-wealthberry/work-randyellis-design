...
describe('CDN Resource Hints', () => {
  ...
  describe('Preconnect Hints', () => {
    it('should include preconnect for critical third-party origins', () => {
      ...
      const googleFonts = hints.find(hint => hint.href === 'https://fonts.googleapis.com');
      const googleFontsStatic = hints.find(hint => hint.href === 'https://fonts.gstatic.com');
    ...
    it('should include crossOrigin attribute where needed', () => {
      ...
      const fontsStaticHint = hints.find(hint => hint.href === 'https://fonts.gstatic.com');
    ...
    it('should include preconnect for analytics', () => {
      ...
      const analyticsHint = hints.find(hint => hint.href === 'https://www.googletagmanager.com');
  ...
  describe('Preload Hints', () => {
    it('should preload critical font files', () => {
      ...
      const geistFont = hints.find(hint => hint.href === '/fonts/geist-variable.woff2');
      const geistMonoFont = hints.find(hint => hint.href === '/fonts/geist-mono-variable.woff2');
  ...
  describe('Connection Warming', () => {
    it('should warm connections to third-party services', () => {
      ...
      expect(preconnectHints.some(hint => hint.href === 'https://fonts.googleapis.com')).toBe(true);
      
      // Analytics should be warmed
      expect(dnsHints).toContain('https://www.googletagmanager.com');
      expect(preconnectHints.some(hint => hint.href === 'https://www.googletagmanager.com')).toBe(true);
    });
  });
});