...
function MockApp() {
  ...
  React.useEffect(() => {
    ...
    // Add event listeners
    document.addEventListener("view-ledgeriq", () =>
      handleViewProject("ledgeriq"),
    );
    ...
    return () => {
      document.removeEventListener("view-ledgeriq", () =>
        handleViewProject("ledgeriq"),
      );
      document.removeEventListener("view-growit", () =>
        handleViewProject("growit"),
      );
...
describe("Complete User Journey E2E Tests", () => {
  ...
  describe("Landing Page Experience", () => {
    it("should render the complete landing page", () => {
      ...
      expect(
        screen.getByText("Randy Ellis - Product Designer"),
      ).toBeInTheDocument();
  ...
  describe("Newsletter Subscription Journey", () => {
    ...
    it("should validate required fields", async () => {
      ...
      expect(
        screen.queryByTestId("newsletter-success"),
  ...
  describe("Project Exploration Journey", () => {
    it("should navigate to project detail page", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText("LedgerIQ: Financial Intelligence Platform"),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should display project details correctly", async () => {
      ...
      expect(
        screen.getByText("40% increase in user engagement"),
      ).toBeInTheDocument();
    });
