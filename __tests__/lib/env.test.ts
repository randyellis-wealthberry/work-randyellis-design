...
describe("Environment Configuration", () => {
  ...
  describe("createAbsoluteUrl", () => {
    it("should create absolute URL from relative path", () => {
      ...
      expect(createAbsoluteUrl("/projects")).toBe(
...
describe("Environment Routing Integration", () => {
  it("should generate consistent URLs across environments", () => {
    ...
    expect(createAbsoluteUrl("/projects/test")).toBe(
      "http://localhost:3000/projects/test",
    );
    restoreDev();
    ...
    expect(createAbsoluteUrl("/projects/test")).toBe(
      "https://work.randyellis.design/projects/test",
    );
    restoreProd();
    ...
    expect(createAbsoluteUrl("/projects/test")).toBe(
      "https://test-preview.vercel.app/projects/test",
    );
    restoreStaging();
  });
