...
describe("Recommendation Analytics Functions", () => {
  ...
  describe("trackRecommendationSectionView", () => {
    ...
    it("should handle empty sections array", () => {
      trackRecommendationSectionView("project", "test-slug", [], 0, 0);
  ...
  describe("Parameter Validation", () => {
    it("should handle empty strings gracefully", () => {
      trackRecommendationSectionView("project", "", ["case_studies"], 1, 0);
    ...
    it("should handle zero position correctly", () => {
      trackRecommendationCardHover("article", "blog", "slug", "name", 0);
