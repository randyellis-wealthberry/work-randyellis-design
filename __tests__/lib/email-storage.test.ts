...
describe("EmailStorage", () => {
  ...
  describe("getSubscription", () => {
    ...
    it("returns null for non-existent subscription", async () => {
      ...
      const result = await emailStorage.getSubscription(
  ...
  describe("updateSubscriptionStatus", () => {
    it("updates subscription status successfully", async () => {
      ...
      const result = await emailStorage.updateSubscriptionStatus(
        "test@example.com",
        "verified",
      );
  ...
  describe("deleteSubscription", () => {
    ...
    it("returns false for non-existent subscription", async () => {
      ...
      const result = await emailStorage.deleteSubscription(
        "nonexistent@example.com",
      );
