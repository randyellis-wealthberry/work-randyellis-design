...
describe('3D WebGL Performance Testing', () => {
  ...
  beforeEach(() => {
    ...
    // Mock WebGL context
    global.HTMLCanvasElement.prototype.getContext = jest.fn(() => createMockWebGLContext());
  ...
  describe('Scene Performance Monitoring', () => {
    test('should monitor frame rate performance for PerformanceOptimizedScene', async () => {
      ...
      const { container } = render(<PerformanceOptimizedScene ref={sceneRef} />);
  ...
  describe('Memory Leak Detection', () => {
    test('should detect no memory leaks in PerformanceOptimizedScene', async () => {
      ...
      const leakTest = await detectMemoryLeaks(renderFunction, 10, 10 * 1024 * 1024);
    ...
    test('should activate fallback when memory budget exceeded', async () => {
      ...
      await waitFor(() => {
        const fallback = container.querySelector('[data-testid="fallback-content"]');
  ...
  describe('Stress Testing', () => {
    ...
    test('should handle multiple concurrent scenes', async () => {
      ...
      const canvases = container.querySelectorAll('[data-testid="three-canvas"]');
