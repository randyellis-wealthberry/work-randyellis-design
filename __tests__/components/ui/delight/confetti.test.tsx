...
import {
  ...
  CelebrationBurst,
  SuccessCheckmark,
} from "@/components/ui/success-confetti";
import {
...
describe("SuccessConfetti Component", () => {
  ...
  it("should create particles when triggered", async () => {
    const { rerender } = render(
      <SuccessConfetti trigger={false} intensity="medium" />,
    );
  ...
  it("should handle different intensity levels", async () => {
    ...
    for (const intensity of intensities) {
      const { unmount } = render(
        <SuccessConfetti trigger={true} intensity={intensity} />,
      );
...
describe("CelebrationBurst Component", () => {
  ...
  it("should call onComplete after animation", async () => {
    ...
    render(
      <CelebrationBurst x={0} y={0} trigger={true} onComplete={onComplete} />,
    );
