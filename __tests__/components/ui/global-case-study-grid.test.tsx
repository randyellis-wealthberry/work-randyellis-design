...
import { trackRecommendationCaseStudyClick, trackRecommendationCardHover } from '@/lib/analytics';
...
describe('GlobalCaseStudyGrid', () => {
  ...
  describe('Data Logic Tests', () => {
    ...
    it('should prioritize featured projects first', () => {
      ...
      expect(within(firstCard).getByText('Featured Project 1')).toBeInTheDocument();
      expect(within(secondCard).getByText('Featured Project 2')).toBeInTheDocument();
    });
    ...
    it('should handle edge case when no case studies available after filtering', () => {
      ...
      render(<GlobalCaseStudyGrid currentSlug="featured-project-1" limit={1} />);
  ...
  describe('Custom Props Tests', () => {
    it('should accept custom title', () => {
      ...
      expect(screen.queryByText('Featured Case Studies')).not.toBeInTheDocument();
    });
    ...
    it('should handle showDescription prop', () => {
      ...
      expect(screen.getByText('This is a featured project description.')).toBeInTheDocument();
    });

    it('should handle showDescription=false prop', () => {
      render(<GlobalCaseStudyGrid showDescription={false} />);
      
      expect(screen.queryByText('This is a featured project description.')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Error Handling Tests', () => {
    it('should handle malformed project data gracefully', () => {
      ...
      expect(screen.getByTestId('case-study-grid-container')).toBeInTheDocument();
    });
  ...
  describe('Analytics Integration', () => {
    const mockTrackRecommendationCaseStudyClick = trackRecommendationCaseStudyClick as jest.MockedFunction<typeof trackRecommendationCaseStudyClick>;
