...
describe("GlobalArticleGrid", () => {
  ...
  describe("Data Logic Tests", () => {
    ...
    it("should prioritize featured articles first", () => {
      ...
      expect(
        within(firstCard).getByText("Featured Article 1"),
      ).toBeInTheDocument();
      expect(
        within(secondCard).getByText("Featured Article 2"),
      ).toBeInTheDocument();
    });
    ...
    it("should sort by date as final tiebreaker", () => {
      ...
      expect(
        within(firstCard).getByText("Featured Article 2"),
      ).toBeInTheDocument();
    });
    ...
    it("should handle edge case when no articles available after filtering", () => {
      ...
      expect(
        screen.queryByTestId("article-grid-container"),
