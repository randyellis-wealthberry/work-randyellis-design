...
jest.mock("@/components/ui/global-case-study-grid", () => ({
  GlobalCaseStudyGrid: ({ title, className, currentSlug, ...props }: any) => (
    <div
      data-testid="global-case-study-grid"
...
jest.mock("@/components/ui/global-article-grid", () => ({
  GlobalArticleGrid: ({ title, className, currentSlug, ...props }: any) => (
    <div
      data-testid="global-article-grid"
      data-current-slug={currentSlug}
      className={className}
    >
...
describe("GlobalRecommendations", () => {
  ...
  describe("Conditional Rendering Tests", () => {
    it("should render only case studies when showArticles=false", () => {
      ...
      expect(screen.getByTestId("global-case-study-grid")).toBeInTheDocument();
      expect(
        screen.queryByTestId("global-article-grid"),
    ...
    it("should render only articles when showCaseStudies=false", () => {
      ...
      expect(
        screen.queryByTestId("global-case-study-grid"),
      ).not.toBeInTheDocument();
      expect(screen.getByTestId("global-article-grid")).toBeInTheDocument();
    });
    ...
    it("should render nothing when both showCaseStudies=false and showArticles=false", () => {
      render(
        <GlobalRecommendations showCaseStudies={false} showArticles={false} />,
      );

      expect(
        screen.queryByTestId("global-recommendations-container"),
      ).not.toBeInTheDocument();
    });
  ...
  describe("Props Forwarding Tests", () => {
    it("should pass currentSlug to both child components", () => {
      ...
      expect(caseStudyGrid).toHaveAttribute(
        "data-current-slug",
        "current-item",
      );
  ...
  describe("Integration Context Tests", () => {
    it("should work correctly on case study pages", () => {
      render(
        <GlobalRecommendations
          currentSlug="current-case-study"
          context="case-study"
        />,
      );

      // Should pass context-appropriate props
      expect(screen.getByTestId("global-case-study-grid")).toHaveAttribute(
        "data-current-slug",
        "current-case-study",
      );
      expect(screen.getByTestId("global-article-grid")).toHaveAttribute(
        "data-current-slug",
        "current-case-study",
      );
    });
  ...
  describe("Analytics Integration", () => {
    const mockTrackRecommendationSectionView =
      trackRecommendationSectionView as jest.MockedFunction<
        typeof trackRecommendationSectionView
      >;
    const mockUsePathname = require("next/navigation")
      .usePathname as jest.MockedFunction<() => string>;
    ...
    it("should not track analytics when nothing should be rendered", () => {
      ...
      render(
        <GlobalRecommendations showCaseStudies={true} showArticles={true} />,
      );
    ...
    it("should handle analytics when pathname is undefined", () => {
      ...
      render(
        <GlobalRecommendations context="project" currentSlug="test-project" />,
      );
