...
describe('CometCardDemo', () => {
  ...
  describe('Responsive Behavior', () => {
    it('should render with proper responsive classes for mobile viewport (<640px)', () => {
      ...
      const cardWrapper = container.querySelector('.relative.aspect-\\[3\\/4\\]');
  ...
  describe('Content Rendering', () => {
    it('should render the METIS player card image', () => {
      ...
      expect(image).toHaveAttribute('src', '/images/projects/metis/playercard-metis.png');
    });
  ...
  describe('Container Behavior', () => {
    it('should be wrapped in CometCard component', () => {
      ...
      const cometCardWrapper = container.querySelector('.perspective-distant.transform-3d');
