...
describe("AdvancedReadTimeBadge", () => {
  ...
  it("should show metadata when provided", () => {
    ...
    render(
      <AdvancedReadTimeBadge readTime={6} metadata={metadata} showMetadata />,
    );
  ...
  it("should handle singular/plural metadata correctly", () => {
    ...
    render(
      <AdvancedReadTimeBadge readTime={3} metadata={metadata} showMetadata />,
    );
  ...
  it("should handle zero values gracefully", () => {
    ...
    render(
      <AdvancedReadTimeBadge readTime={1} metadata={metadata} showMetadata />,
    );
  ...
  it("should format large word counts with commas", () => {
    ...
    render(
      <AdvancedReadTimeBadge readTime={15} metadata={metadata} showMetadata />,
    );
