...
const mockUserTestingData = {
  methodology: "15 high school students testing with multiple devices (iOS, Android) in school library and hallways",
...
describe('UserTestingSection', () => {
  ...
  describe('component rendering', () => {
    it('renders the user testing section title', () => {
      ...
      expect(screen.getByTestId("section-title")).toHaveTextContent(/user testing/i);
    });
    ...
    it('shows testing environment details', () => {
      ...
      expect(screen.getByTestId("environment-text")).toHaveTextContent(/School Library and Hallways/i);
    });
  ...
  describe('results display', () => {
    ...
    it('displays result labels', () => {
      ...
      expect(screen.getByText(/Student Recommendation Rate/i)).toBeInTheDocument();
    });
  });
  ...
  describe('error handling', () => {
    it('handles missing testimonials gracefully', () => {
      const dataWithoutTestimonials = { ...mockUserTestingData, testimonials: [] };
