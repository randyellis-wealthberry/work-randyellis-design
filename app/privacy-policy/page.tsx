  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <strong>Name:</strong> If provided during newsletter signup (optional)
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <strong>IP Address:</strong> For rate limiting and analytics purposes
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Newsletter Communications:</strong> Sending business strategy
        ...
        <li>
          <strong>Security:</strong> Rate limiting to prevent abuse and protect
          our services
        </li>
        <li>
          <strong>Legal Compliance:</strong> Meeting regulatory requirements and
          protecting rights
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>Vercel Analytics:</strong> Monitors site performance and user
          experience
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>Legitimate Interest:</strong> Website analytics, security, and
          improvements
        </li>
        <li>
        ...
        <li>
          <strong>Contract:</strong> Providing requested services or information
        </li>
      </ul>

      <h2>12. Data Protection Officer</h2>
      <p>
        For data protection inquiries specific to GDPR compliance, you can reach
        our privacy contact at the email address above.
      </p>
    </LegalDocument>
  );
}
