...
jest.mock('@/components/ui/mobile-menu', () => {
  return function MockMobileMenu({ isOpen, onOpenChange }: any) {
    return (
      <div data-testid="mobile-menu">
        ...
        {isOpen && (
          <div data-testid="mobile-menu-panel">
            ...
            <a href="/" onClick={() => onOpenChange(false)}>Home</a>
            <a href="/about" onClick={() => onOpenChange(false)}>About</a>
            <a href="/projects" onClick={() => onOpenChange(false)}>Projects</a>
          </div>
        )}
      </div>
    );
...
describe('Header Component', () => {
  ...
  describe('Desktop Navigation', () => {
    ...
    it('should render all desktop navigation links', () => {
      ...
      expect(homeLink).toHaveAttribute('href', 'https://work.randyellis.design');
  ...
  describe('Header Content', () => {
    it('should render site title correctly', () => {
      ...
      expect(siteTitle).toHaveAttribute('href', 'https://work.randyellis.design');
    ...
    it('should render subtitle correctly', () => {
      ...
      const subtitle = screen.getByText('Generative AI & Product Design Engineer');
