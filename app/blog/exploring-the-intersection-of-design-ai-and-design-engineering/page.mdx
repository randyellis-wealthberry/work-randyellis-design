import { Cover } from "@/mdx-components";
...
export const metadata = createArticleMetadata({
  title: "Exploring Design, AI, and Design Engineering",
  description:
  ...
  tags: ["AI", "Design Engineering", "Product Design", "Design Systems"],
  image:
    "/images/blog/exploring-the-intersection-of-design-ai-and-design-engineering/hero.jpg",
});
...
<BlogPostJsonLd
  ...
  imageUrl="https://work.randyellis.design/images/blog/exploring-the-intersection-of-design-ai-and-design-engineering/hero.jpg"
  keywords={[
    "AI",
    "Design Engineering",
    "Product Design",
...
<div className="not-prose">
  <BlogHeroWrapper
    title="Exploring the Intersection of Design, AI, and Design Engineering"
    description="Design and artificial intelligence (AI) are increasingly intertwined, driving innovation across industries. As technology evolves, the role of design engineering is more critical than ever, bridging creativity and functionality."
    heroImage="/images/blog/exploring-the-intersection-of-design-ai-and-design-engineering/hero.jpg"
    heroAlt="Futuristic AI and design interface representing the intersection of artificial intelligence and design engineering"
    author="Randy Ellis"
    date="2024-01-15"
  />
</div>
