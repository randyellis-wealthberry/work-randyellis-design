...
export const metadata = createArticleMetadata({
  ...
  image: "/images/blog/profits-not-pixels/hero.jpg",
});
...
<BlogPostJsonLd
  ...
  imageUrl="https://work.randyellis.design/images/blog/profits-not-pixels/hero.jpg"
  keywords={[
    "Design Leadership",
    "Business Impact",
    "Design Career",
