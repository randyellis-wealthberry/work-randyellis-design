...
export const metadata = createArticleMetadata({
  title: "Claude + Obsidian: The Ultimate Knowledge System",
  description:
  ...
  path: "/blog/claude-obsidian-workflows",
  publishedTime: "2025-01-15",
  tags: ["Claude Code", "Obsidian", "Knowledge Management", "Productivity"],
  image: "/images/blog/claude-obsidian-workflows/hero.png",
});
