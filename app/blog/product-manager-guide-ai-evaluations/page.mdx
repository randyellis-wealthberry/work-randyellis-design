...
<ArticleStructuredData
  title="The Product Manager's Guide to AI Evaluations: Building Better AI Products"
  description="Learn why systematic AI evaluation is essential for product managers, and discover a practical framework for assessing and improving generative AI systems."
  datePublished="2025-07-20"
  url="https://work.randyellis.design/blog/product-manager-guide-ai-evaluations"
  keywords={[
    "AI Evaluation",
    "Product Management",
    "Generative AI",
