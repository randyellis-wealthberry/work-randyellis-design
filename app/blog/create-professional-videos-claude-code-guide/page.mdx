...
export const metadata = {
  ...
  alternates: {
    canonical: "/blog/create-professional-videos-claude-code-guide",
  },
...
<ArticleStructuredData
  title="How to Create Professional Videos with Claude Code: A Complete Guide to AI-Powered Video Generation Using Remotion and Manim"
  description="Learn how to leverage Claude Code to create stunning videos programmatically using Remotion and Manim libraries. A comprehensive guide for marketers, developers, and content creators."
  datePublished="2024-12-15"
  url="https://work.randyellis.design/blog/create-professional-videos-claude-code-guide"
  imageUrl="https://work.randyellis.design/images/blog/create-professional-videos-claude-code-guide/hero.jpg"
  keywords={[
    "Claude Code",
    "Video Generation",
    "Remotion",
...
<div className="not-prose">
  <BlogHeroWrapper
    title="How to Create Professional Videos with Claude Code: A Complete Guide to AI-Powered Video Generation Using Remotion and Manim"
    description="Learn how to leverage Claude Code to create stunning videos programmatically using Remotion and Manim libraries. A comprehensive guide for marketers, developers, and content creators."
    heroImage="/images/blog/create-professional-videos-claude-code-guide/hero.jpg"
    heroAlt="Professional video creation setup with camera and lighting equipment representing AI-powered video generation"
    author="Randy Ellis"
    date="2024-12-15"
  />
</div>
