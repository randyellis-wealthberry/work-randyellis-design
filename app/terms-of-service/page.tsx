...
export default function TermsOfServicePage() {
  return (
    <LegalDocument
      title="Terms of Service"
      updated="2026-08-19"
      updatedLabel="19 August 2026"
    >
      <h2>1. Acceptance of Terms</h2>
      <p>
        By accessing and using work.randyellis.design (&quot;the Website&quot;),
        you accept and agree to be bound by the terms and provision of this
        agreement. These Terms of Service (&quot;Terms&quot;) constitute a
        legally binding agreement between you and Randy Ellis (&quot;we,&quot;
        &quot;us,&quot; or &quot;our&quot;).
      </p>
      ...
      <ul>
        <li>Newsletter subscription service with business strategy content</li>
      ...
      <ul>
        <li>
          You may subscribe to our newsletter by providing a valid email address
        </li>
        ...
        <li>
          You can unsubscribe at any time using the links provided in our emails
        </li>
      </ul>
      ...
      <ul>
        <li>
          Viewing and reading content for personal and professional development
        </li>
      ...
      <ul>
        <li>
          All content, including text, images, videos, and designs, is owned by
          Randy Ellis or licensed to us
        </li>
        <li>
      ...
      <ul>
        <li>
          Newsletter content focuses on business strategy for product designers
        </li>
      ...
      <ul>
        ...
        <li>Processing unsubscribe requests may take up to 5 business days</li>
      </ul>
      ...
      <p>
        TO THE MAXIMUM EXTENT PERMITTED BY LAW, RANDY ELLIS SHALL NOT BE LIABLE
      ...
      <p>
        ...
        subscribers of material changes via email.
      </p>
      ...
      <p>
        ...
        necessary so that the remaining Terms will remain in full force and
        effect.
      </p>
