...
## Where these live on the site (as of 2026-08-21)

One primitive, one editorial job, applied site-wide:

| Primitive                                             | Job                                                                      | Mounted in                                                                                                                                                           |
| ----------------------------------------------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AnimatedContent` / `AnimatedContentItem`             | staggered reveal of data grids                                           | `components/client-logos.tsx`, `app/about/about-client.tsx` (Career Impact, testimonials), `app/projects/echo/echo-client.tsx` (features), `rambis-grid-example.tsx` |
| `GlareHover` / `GlarePresets`                         | project thumbnails on hover                                              | `app/page.tsx` (Selected Projects), `app/projects/projects-client.tsx`, `rambis-grid-example.tsx`                                                                    |
| `FadeContent` / `ProgressiveDisclosure`               | sequential header/footer reveal                                          | `rambis-grid-example.tsx`, `test-demo.tsx`                                                                                                                           |
| `AnimatedNumber`                                      | outcome metrics count-up (via `components/ui/animated-metric-value.tsx`) | `app/projects/rambis-ui/rambis-client.tsx`, `app/projects/echo/echo-client.tsx`                                                                                      |
| `Disclosure`                                          | progressive detail behind a headline                                     | `app/projects/rambis-ui/rambis-client.tsx` (Key Improvements)                                                                                                        |
| `BorderTrail`                                         | the one primary-action highlight                                         | `components/ui/cta-section.tsx` (shared CTA)                                                                                                                         |
| `TextShimmer`                                         | in-progress terminal lines                                               | `app/page.tsx` (`TerminalDemo`, steps flagged `shimmer: true`)                                                                                                       |
| `Tilt`                                                | feature cards with depth                                                 | `app/projects/waffle/waffle-client.tsx`, `app/projects/rambis-ui/rambis-client.tsx`                                                                                  |
| `GlowEffect`                                          | hero media frame                                                         | `app/projects/waffle/waffle-client.tsx`, `app/projects/addvanced/addvanced-client.tsx`, `app/projects/[slug]/project-detail-client.tsx`                              |
| `ScrollProgress`                                      | reading progress on long pages                                           | `app/blog/page.tsx`, `app/projects/{addvanced,echo,rambis-ui}`, `app/projects/[slug]`                                                                                |
| `AnimatedGroup`                                       | wireframe grid stagger                                                   | `components/ui/wireframes-section.tsx` → mounted in `app/projects/addvanced/addvanced-client.tsx`                                                                    |
| `RambisAnimatedGrid` / `PerformanceMonitoredGrid`     | challenges → solutions grid                                              | `app/projects/rambis-ui/rambis-client.tsx`                                                                                                                           |
| `MotionPrimitivesDemo`                                | internal showcase                                                        | `app/admin/motion-primitives-demo/page.tsx` (noindex)                                                                                                                |
| `InView`, `TextEffect`, `TransitionPanel`, `Magnetic` | unchanged                                                                | blog, grids, homepage, waffle                                                                                                                                        |
