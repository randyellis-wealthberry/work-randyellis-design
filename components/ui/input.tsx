  ...
  ],
  {
    variants: {
      variant: {
        ...
        floating: "border-zinc-300 dark:border-zinc-600 pt-7 pb-3",
      },
      size: {
  ...
  return (
    <div className="relative">
      ...
      <label
        htmlFor={inputId}
        className={cn(
          "absolute left-4 top-2.5 text-xs font-semibold transition-all duration-200 tracking-wide",
          ...
          "peer-focus:top-2 peer-focus:text-xs peer-focus:font-semibold peer-focus:translate-y-0 peer-focus:tracking-wide",
